...
typedef struct Coordinate
{
  ...
  Coordinate(uint32_t _x = 0, uint32_t _y = 0) 
  : x(_x),
    y(_y) {}
...
public:
  ...
  static Color const& get_basic_node_color();
};
...
public:
  GridRenderer(SDL_Renderer* _renderer)
  : renderer(_renderer) {}
